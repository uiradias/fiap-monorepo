...
class SnsSessionEventPublisherIT extends LocalStackTestcontainersBase {
    ...
    static void wire() {
        ...
        sqs =
                SqsClient.builder()
                        ...
                        .build();
        topicArn =
                sns.createTopic(CreateTopicRequest.builder().name("session-events-it").build())
                        .topicArn();
        queueUrl =
                sqs.createQueue(
                                CreateQueueRequest.builder()
                                        .queueName("session-events-it-q")
                                        .build())
                        .queueUrl();
        String queueArn =
    ...
    void publishes_a_well_formed_session_event_with_attributes() throws Exception {
        ...
        SnsSessionEventPublisher publisher =
                new SnsSessionEventPublisher(sns, topicArn, validator, new ObjectMapper());
