...
class SqsAnalysisJobPublisherIT extends LocalStackTestcontainersBase {
    ...
    static void createQueue() {
        sqs =
                SqsClient.builder()
                        ...
                        .build();
        queueUrl =
                sqs.createQueue(CreateQueueRequest.builder().queueName("analysis-jobs-it").build())
                        .queueUrl();
    }
    ...
    void publishes_a_well_formed_job() throws Exception {
        ...
        SqsAnalysisJobPublisher publisher =
                new SqsAnalysisJobPublisher(sqs, queueUrl, validator, new ObjectMapper());
