...
public class IntegrationTestAwsConfig {
    ...
    @Bean
    public S3AssetStorageAdapter s3AssetStorageAdapter(
    ...
    public SessionEventSqsConsumer sessionEventSqsConsumer(
        ...
        ContractValidator validator =
                new ContractValidator(new File(contractsDir).getAbsoluteFile());
        Clock clock = Instant::now;
        return new SessionEventSqsConsumer(
                sqsClient, queueUrl, waitSeconds, mapper, validator, recorder, clock);
    }
}
