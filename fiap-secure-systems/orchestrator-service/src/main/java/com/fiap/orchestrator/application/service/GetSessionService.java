...
public class GetSessionService implements GetSessionUseCase {
    ...
    @Override public Optional<Session> findSession(SessionId id) { return sessions.findById(id); }
    @Override public Optional<AnalysisReport> findReport(SessionId id) { return reports.findBySessionId(id); }
}
