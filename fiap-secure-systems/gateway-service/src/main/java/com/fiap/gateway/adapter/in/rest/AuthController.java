...
public class AuthController {
    ...
    public AuthController(RegisterUserUseCase r, LoginUseCase l, RefreshTokenUseCase rt, LogoutUseCase lo) {
    ...
    public ResponseEntity<Map<String, UUID>> register(@Valid @RequestBody RegisterRequest body) {
        var u = registerUseCase.register(Email.of(body.email()), body.password(), body.displayName());
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(Map.of("userId", u.id().value()));
    }
