...
public record AnalysisOutcome(
        ...
        switch (status) {
            case SUCCEEDED -> {
                if (result == null || modelMetadata == null) {
                    throw new IllegalArgumentException("SUCCEEDED requires result and modelMetadata");
                }
    ...
    public Optional<Map<String, Object>> resultOpt() { return Optional.ofNullable(result); }

    /** Convenience: modelMetadata wrapped in Optional. */
    public Optional<Map<String, Object>> modelMetadataOpt() { return Optional.ofNullable(modelMetadata); }

    /** Convenience: failure wrapped in Optional. */
    public Optional<AnalysisFailure> failureOpt() { return Optional.ofNullable(failure); }
}
